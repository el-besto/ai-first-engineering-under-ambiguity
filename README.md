...
A foundational set of default environment variables are documented and exposed in `.env.local.example`. To set up your local environment:
...
When writing new features, please add their associated environment variables to the specific config models (e.g. `APIConfig` or `UIConfig`) and update `.env.local.example` and this README accordingly.
