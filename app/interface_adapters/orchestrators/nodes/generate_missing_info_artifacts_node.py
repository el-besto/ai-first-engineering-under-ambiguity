...
def build_generate_missing_info_artifacts_node(model: ModelAdapter):
    def generate_missing_info_artifacts_node(state: TriageGraphState) -> dict[str, Any]:
        ...
        try:
            ...
            missing_info_updates = generate_missing_info_artifacts(
                model, tokenized_facts, updates.get("requirements_checklist", "")
            )
            updates.update(missing_info_updates)
    ...
    return generate_missing_info_artifacts_node
