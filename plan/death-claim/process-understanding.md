...
This document captures the current-state process understanding and the PoC-improved flow for the selected death-claim intake slice. Its goal is to make the research claim in [PROJECT_PLAN.md](../../PROJECT_PLAN.md) explicit and reusable in both implementation planning and the final demo narrative.
